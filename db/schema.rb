...
ActiveRecord::Schema.define(version: 2020_10_18_022642) do
  ...
  create_table "secret_petitions", force: :cascade do |t|
    t.integer "chain_id"
    t.integer "user_id"
    t.string "title"
    t.text "description"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer "petition_type", default: 0
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean "committee_member", default: false, null: false
    t.boolean "puzzle_staker", default: false, null: false
