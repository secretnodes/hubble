class CreateSecretChainTables < ActiveRecord::Migration[5.2]
  def change
    create_table :secret_accounts do |t|
      t.string :address
      t.bigint :chain_id
      t.bigint :validator_id
      t.timestamps
    end
    add_index :secret_accounts, :address
    add_index :secret_accounts, :chain_id

    create_table :secret_blocks do |t|
      t.bigint :chain_id
    ...
    create_table :secret_chains do |t|
    ...
    create_table :secret_faucets do |t|
      t.bigint :chain_id
      t.boolean :disabled, default: false
    ...
    create_table :secret_governance_deposits do |t|
      t.bigint :account_id
    ...
    create_table :secret_governance_proposals do |t|
      t.bigint :chain_id
      t.bigint :ext_id
      t.string :title
      t.text :description
    ...
    create_table :secret_governance_votes do |t|
      t.bigint :account_id
      t.bigint :proposal_id
      t.string :option
      t.timestamps
    ...
    create_table :secret_validators do |t|
      t.bigint :chain_id
      t.string :address, null: false
