...
Puzzle is a place where secret stakeholders can put the pieces together. The intent of this project is not to merely create just another block explorer, it's to create a custom experience that highlights network information around Secret Nodes performance & governance on the Enigma Blockchain.
